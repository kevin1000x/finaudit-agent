...
**接手时先清点磁盘，发现 handoff 与实际不符**
- `references/` 里有三份**未提交**产物（合计 697 行），时间戳 2026-08-19 22:51–22:52，
  而 handoff 第三轮更新提交（`129f049`）是同日 22:15 ⇒ 上一轮写完 handoff 之后又跑了三件续读，
  产出未提交也未记进 handoff。本轮按 handoff 的「仍未读」派 agent 时**差点重跑已完成部分**。→ 台账 N-32
